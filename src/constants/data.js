...
export const skills = [
  {
    name: "JavaScript",
    description:
      "JavaScript is a high-level, dynamic programming language that enables interactive web pages. It's the core technology of the web alongside HTML and CSS, and it's used for both frontend and backend development.",
    image:
  ...
  },
  {
    name: "React",
    description:
      "React is a popular JavaScript library developed by Facebook for building fast and interactive user interfaces. It uses a component-based architecture and a virtual DOM for efficient rendering.",
    image:
  ...
  },
  {
    name: "Next.js",
    description:
      "Next.js is a powerful React framework that enables server-side rendering, static site generation, and API routes. It enhances performance, SEO, and developer experience in modern web apps.",
    image:
  ...
  },
  {
    name: "Node.js",
    description:
      "Node.js is a JavaScript runtime built on Chrome's V8 engine. It allows developers to build scalable backend services and APIs using JavaScript on the server-side.",
    image:
  ...
  },
  {
    name: "Express.js",
    description:
      "Express.js is a minimal and flexible Node.js web application framework that provides a robust set of features for building single-page, multi-page, and RESTful APIs.",
    image: "/images/express.webp",
  },
  {
    name: "MongoDB",
    description:
      "MongoDB is a NoSQL database that stores data in JSON-like documents. It is highly scalable and ideal for handling large amounts of unstructured data.",
    image:
  ...
  },
  {
    name: "Postman",
    description:
      "Postman is an API platform used by developers to design, test, and document APIs. It simplifies HTTP request testing and enhances collaboration across teams.",
    image: "https://www.vectorlogo.zone/logos/getpostman/getpostman-icon.svg",
  },
  {
    name: "Tailwind CSS",
    description:
      "Tailwind CSS is a utility-first CSS framework that allows you to style elements by applying pre-defined classes directly in your markup, speeding up the UI development process.",
    image: "/images/icon.tailwind.png",
  },
  {
    name: "Bootstrap",
    description:
      "Bootstrap is a responsive CSS framework developed by Twitter. It includes prebuilt components and layout tools for building mobile-first, responsive websites quickly.",
    image:
  ...
  },
  {
    name: "Git",
    description:
      "Git is a distributed version control system used to track changes in source code. It allows multiple developers to collaborate on projects efficiently and safely.",
    image:
  ...
  },
  {
    name: "Vercel",
    description:
      "Vercel is a cloud platform for static sites and serverless functions. It's the official hosting platform for Next.js and enables fast global deployments with an optimized developer experience.",
    image: "/images/vercel.jpeg",
  },
  {
    name: "Cloudinary",
    description:
      "Cloudinary is a cloud-based image and video management platform that enables developers to upload, store, manipulate, optimize, and deliver media assets efficiently across web and mobile applications.",
...
export const socials = [
  {
    ...
    onClick: () => {
      window.open(
        "https://www.linkedin.com/in/monirhdigital",
        "_blank",
        "noopener,noreferrer",
      );
    },
  },
  {
    ...
    onClick: () => {
      window.open(
        "https://github.com/monir-hossaien",
        "_blank",
        "noopener,noreferrer",
      );
    },
...
export const projects = [
  {
    ...
    live: "https://raangalay-ecommerce.vercel.app",
  },
  {
    id: 2,
    title: "Doctor Finder",
    description:
      "A MERN-based platform to search doctors by location, specialty, and hospital. Includes secure JWT authentication, admin dashboard, and a full appointment booking system with modern UI/UX.",
